...
CREATE DATABASE Partition_Vinabook
GO
Use Partition_Vinabook
GO
ALTER DATABASE Partition_Vinabook
ADD FILEGROUP FG1;  
GO  
ALTER DATABASE Partition_Vinabook
ADD FILEGROUP FG2;  
...
ADD FILE   
(  
    NAME='Partition_Vinabook1',
	FILENAME=
	'D:\Partition_Vinabook\FG1\Partition_Vinabook1.mdf',
	SIZE=2,
	MAXSIZE=100,
	FILEGROWTH=1 
)  
...
ADD FILE   
(  
    NAME='Partition_Vinabook2',
	FILENAME=
	'D:\Partition_Vinabook\FG2\Partition_Vinabook2.ndf',
	SIZE=2,
	MAXSIZE=100,
	FILEGROWTH=1 
)  
...
ADD FILE   
(  
    NAME='Partition_Vinabook3',
	FILENAME=
	'D:\Partition_Vinabook\FG3\Partition_Vinabook3.ndf',
	SIZE=2,
	MAXSIZE=100,
	FILEGROWTH=1 
)  
...
ADD FILE   
(  
    NAME='Partition_Vinabook4',
	FILENAME=
	'D:\Partition_Vinabook\FG4\Partition_Vinabook4.ndf',
	SIZE=2,
	MAXSIZE=100,
	FILEGROWTH=1 
)  
...
ADD FILE   
(  
    NAME='Partition_Vinabook5',
	FILENAME=
	'D:\Partition_Vinabook\FG5\Partition_Vinabook5.ndf',
	SIZE=2,
	MAXSIZE=100,
	FILEGROWTH=1 
)  
...
Use Partition_Vinabook
GO
--drop PARTITION FUNCTION MA_SACH_Partitions
CREATE PARTITION FUNCTION MA_SACH_Partitions (int)
AS RANGE RIGHT FOR VALUES ( 1000, 2000,3000,4000)
GO

CREATE PARTITION SCHEME PS_MA_SACH
AS PARTITION MA_SACH_Partitions
